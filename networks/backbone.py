...
'''
    Implementation of dilated ResNet-101 with deep supervision. Downsampling is changed to 16x
'''
model_urls = {
...
class _DenseLayer(nn.Sequential):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate):
        ...
        self.add_module('norm.1', BatchNorm2d(num_input_features)),
        self.add_module('relu.1', nn.ReLU(inplace=False)),
        self.add_module('conv.1', nn.Conv2d(num_input_features, bn_size *
                                            growth_rate, kernel_size=1, stride=1, bias=False)),
        self.add_module('norm.2', BatchNorm2d(bn_size * growth_rate)),
        self.add_module('relu.2', nn.ReLU(inplace=False)),
